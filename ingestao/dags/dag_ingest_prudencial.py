...
with DAG(
    ...
    tags=["healthintel", "financeiro", "prudencial", "delta_ans_100"],
) as dag:
    ingerir_prudencial = BashOperator(
        task_id="ingerir_prudencial_operadora",
        cwd="/workspace",
        env={
        ...
        append_env=True,
        bash_command=_BASE.format(func="executar_ingestao_prudencial_operadora"),
    )
