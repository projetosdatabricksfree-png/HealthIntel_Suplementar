...
from ingestao.app.elt.orchestrator import executar_elt_extract_all
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Baixa fontes ANS catalogadas para landing zone.")
