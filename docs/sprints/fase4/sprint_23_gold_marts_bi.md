...
- [ ] Criar `healthintel_dbt/models/marts/dimensao/dim_modalidade.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/dimensao/dim_segmentacao.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/dimensao/dim_tipo_contratacao.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/fato/mart_operadora_360.sql`:
...
- [ ] Documentar em `_marts_gold.yml`: grão, chaves, métricas disponíveis, fonte de cada coluna.

### HIS-23.3 — mart_mercado_municipio

- [ ] Criar `healthintel_dbt/models/marts/fato/mart_mercado_municipio.sql`:
...
- [ ] Documentar em `_marts_gold.yml`.

### HIS-23.4 — mart_regulatorio_operadora

- [ ] Criar `healthintel_dbt/models/marts/fato/mart_regulatorio_operadora.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/fato/mart_rede_assistencial.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/fato/mart_score_operadora.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/fato/mart_tiss_procedimento.sql`:
...
- [ ] Criar `healthintel_dbt/models/marts/fato/_marts_gold.yml`:
...
- [ ] `models/marts/dimensao/dim_modalidade.sql`
- [ ] `models/marts/dimensao/dim_segmentacao.sql`
- [ ] `models/marts/dimensao/dim_tipo_contratacao.sql`
- [ ] `models/marts/fato/mart_operadora_360.sql`
- [ ] `models/marts/fato/mart_mercado_municipio.sql`
- [ ] `models/marts/fato/mart_regulatorio_operadora.sql`
- [ ] `models/marts/fato/mart_rede_assistencial.sql`
- [ ] `models/marts/fato/mart_score_operadora.sql`
- [ ] `models/marts/fato/mart_tiss_procedimento.sql`
- [ ] `models/marts/fato/_marts_gold.yml` com column-level docs e testes
- [ ] `models/marts/dimensao/_dimensao.yml` atualizado com novas dimensões
- [ ] Testes singulares `assert_mart_*.sql`

## Validação esperada

- [ ] `dbt compile --select tag:mart`
- [ ] `dbt build --select tag:mart` — sem falhas em dados demo
- [ ] `dbt test --select tag:mart` — zero falhas
- [ ] `mart_operadora_360` materializado em `nucleo_ans` com dados para `competencia=202501`
